...
class TelegramBotApi
{
	...
	{
		return $this->client->sendRequest(__FUNCTION__, get_defined_vars());
	}
	 ...
	 * @return bool
	 */
	public function setStickerSetThumbnail(string $name, int $userId, InputFile|string|null $thumbnail = null): bool
	{
		return $this->client->sendRequest(__FUNCTION__, get_defined_vars());
	}
