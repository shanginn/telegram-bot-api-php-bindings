...
class KeyboardButton implements TypeInterface
{
     ...
     * @param KeyboardButtonRequestUser|null $requestUser     Optional. If specified, pressing the button will open a list of suitable users. Tapping on any user will send their identifier to the bot in a “user_shared” service message. Available in private chats only.
     * @param KeyboardButtonRequestChat|null $requestChat     Optional. If specified, pressing the button will open a list of suitable chats. Tapping on a chat will send its identifier to the bot in a “chat_shared” service message. Available in private chats only.
    ...
    public function __construct(
        public string $text,
        public ?KeyboardButtonRequestUser $requestUser = null,
