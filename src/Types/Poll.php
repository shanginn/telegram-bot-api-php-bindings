...
class Poll implements TypeInterface
{
     ...
     * @param array<MessageEntity>|null $questionEntities      Optional. Special entities that appear in the question. Currently, only custom emoji entities are allowed in poll questions
