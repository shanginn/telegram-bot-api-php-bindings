...
class InlineKeyboardButton implements TypeInterface
{
     ...
     * @param string|null                      $callbackData                 Optional. Data to be sent in a callback query to the bot when button is pressed, 1-64 bytes. Not supported for messages sent on behalf of a Telegram Business account.
