...
class Chat implements TypeInterface
{
    ...
    public static function fromResponseResult(array $result): self
    {
        ...
        return new self(
            ...
            bio: $result['bio'] ?? null,
            hasPrivateForwards: $result['has_private_forwards'] ?? null,
            hasRestrictedVoiceAndVideoMessages: $result['has_restricted_voice_and_video_messages'] ?? null,
            joinToSendMessages: $result['join_to_send_messages'] ?? null,
            joinByRequest: $result['join_by_request'] ?? null,
            ...
            hasAggressiveAntiSpamEnabled: $result['has_aggressive_anti_spam_enabled'] ?? null,
            hasHiddenMembers: $result['has_hidden_members'] ?? null,
            hasProtectedContent: $result['has_protected_content'] ?? null,
            stickerSetName: $result['sticker_set_name'] ?? null,
            canSetStickerSet: $result['can_set_sticker_set'] ?? null,
