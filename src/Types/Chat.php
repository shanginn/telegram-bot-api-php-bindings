...
class Chat implements TypeInterface
{
     ...
     * @param Birthdate|null            $birthdate                          Optional. For private chats, the date of birth of the user. Returned only in getChat.
     * @param BusinessIntro|null        $businessIntro                      Optional. For private chats with business accounts, the intro of the business. Returned only in getChat.
     * @param BusinessLocation|null     $businessLocation                   Optional. For private chats with business accounts, the location of the business. Returned only in getChat.
     * @param BusinessOpeningHours|null $businessOpeningHours               Optional. For private chats with business accounts, the opening hours of the business. Returned only in getChat.
     * @param Chat|null                 $personalChat                       Optional. For private chats, the personal channel of the user. Returned only in getChat.
     * @param array<ReactionType>|null  $availableReactions                 Optional. List of available reactions allowed in the chat. If omitted, then all emoji reactions are allowed. Returned only in getChat.
     * @param int|null                  $accentColorId                      Optional. Identifier of the accent color for the chat name and backgrounds of the chat photo, reply header, and link preview. See accent colors for more details. Returned only in getChat. Always returned in getChat.
     * @param string|null               $backgroundCustomEmojiId            Optional. Custom emoji identifier of emoji chosen by the chat for the reply header and link preview background. Returned only in getChat.
     * @param int|null                  $profileAccentColorId               Optional. Identifier of the accent color for the chat's profile background. See profile accent colors for more details. Returned only in getChat.
     * @param string|null               $profileBackgroundCustomEmojiId     Optional. Custom emoji identifier of the emoji chosen by the chat for its profile background. Returned only in getChat.
     * @param string|null               $emojiStatusCustomEmojiId           Optional. Custom emoji identifier of the emoji status of the chat or the other party in a private chat. Returned only in getChat.
     * @param int|null                  $emojiStatusExpirationDate          Optional. Expiration date of the emoji status of the chat or the other party in a private chat, in Unix time, if any. Returned only in getChat.
